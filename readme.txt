...
v.1.1.4 - Added more style options, like changing font sizes and background colors; also, I removed some hard-coded styles so that you may set them yourself in the css file. Hope that doesn't break things....
